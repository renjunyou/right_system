...
public class DateUtils {
    ...
    // 获得上周一0点时间  
    public static Date getLastWeekStartMorning() {  
        Calendar cal = Calendar.getInstance();  
    ...
    // 获得上周日24点时间  
    public static Date getLastWeekEndNight() {  
        Calendar cal = Calendar.getInstance();
        cal.setTime(getTimesWeekmorning());  
        return cal.getTime();  
    }
    ...
    public static Date getDate(Date d,int unit,int val) {  
        Calendar cal = Calendar.getInstance();  
        cal.setTime(d );  
        cal.add(unit, val);  
        return cal.getTime();  
